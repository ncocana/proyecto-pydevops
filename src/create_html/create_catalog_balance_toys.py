...
def create_catalog_balance_toys():

    try:
        #Assigns the desired path to where the html file will create itself. In this case, the html will be in './docs/catalog-bikes-balance-toys.html'.
        working_directory = Path(getCurrentDirectory())
        path = working_directory / "docs" / "catalog-bikes-balance-toys.html"
    ...
    <html lang="en">
        <head>
            <title>Rental Bike - Catalog of Balance Toys</title>
            <meta charset="UTF-8">
        ...
        #that have 'Balance toys' as its mark.
        for document in get_bikes_by_mark('Balance toys')['documents']:
            ...
            #This will add the following html code to the variable 'html', creating a box in catalog-bikes-balance-toys.html with the bike's information.
        ...
        #Writes the content of the variable 'html' in the file created previously (catalog-bikes-balance-toys.html), and then closes it.
        file.write(html)
        file.close()
