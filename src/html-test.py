...
from queries_db.get_bikes_sorted_by_price import get_bikes_sorted_by_price

def print_html():
    x=get_bikes_sorted_by_price()['documents'][0]['type']
    y=get_bikes_sorted_by_price()['documents'][-1]['type']
    line1 = '<!DOCTYPE html>'
